...
@property (nonatomic, assign) BOOL isNeedLRSideBorder;
@property (nonatomic, assign) BOOL isNeedSetContentColor;

@property (nonatomic, assign) CGFloat leftRightOfSideBorderWidth;
@property (nonatomic, assign) CGFloat topBorderWidth;
@property (nonatomic, assign) CGFloat bottomBorderWidth;

@property (nonatomic, strong) UIColor *contentFillColor;
@property (nonatomic, strong) UIColor *leftRightOfSideStrokeColor;
