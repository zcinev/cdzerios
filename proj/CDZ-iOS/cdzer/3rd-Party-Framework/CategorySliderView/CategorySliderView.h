...
@property (assign) BOOL shouldAutoScrollSlider; // default YES Autos scrolls closest category after scroll drag ends
@property (assign) BOOL shouldAutoSelectScrolledCategory; // default YES Autos selects the slided category
