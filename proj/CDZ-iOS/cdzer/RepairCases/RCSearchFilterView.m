...
- (void)initializationUIWithMaskView:(UIButton *)maskBtnView {
    @autoreleasepool {
        ...
        NSArray *titleArray = @[@"price_default_order_by"];
        ...
        [self setSelectionList:@[@[getLocalizationString(@"price_default_order_by"),
                                   getLocalizationString(@"price_default_order_by_descent"),
                                   getLocalizationString(@"price_default_order_by_ascent")]]];
