...
#define vMinHeight (115.0f)
#import "ItemsTabViewCell.h"

@interface ItemsTabViewCell ()
...
@implementation ItemsTabViewCell

- (void)initializationUI {
    CGFloat positionX = (16.0f);
    CGFloat positionY = (4.0f);
...
//    }
    ...
    if (!_commentDescriptionLabel) {
        ...
        rect.origin.y = CGRectGetMaxY(_userNameLabel.frame)+(6.0f);
...
//     {
//         "autopart_name" = "<null>";
//         content = "\t\U53ef\U4ee5\U7684\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t";
//         "create_time" = "2015-06-30 10:11:03 ";
//         "face_img" = "";
//         star = "1.0";
//         userName = "131****0051";
//     },
...
//         "autopart_name" = "<null>";
//         content = "\U4e0d\U9519";
//         "create_time" = "2015-06-25 17:12:02 ";
//         "face_img" = "http://cdz.cdzer.com:80/imgUpload/demo/basic/faceImg/150627092438056492HPvN.jpg";
//         star = "1.0";
//         userName = "150****7814";
//     },
//     {
//         "autopart_name" = "<null>";
//         content = "\U4e0d\U597d\t\t\t\t\t";
//         "create_time" = "2015-06-25 15:11:20 ";
//         "face_img" = "http://cdz.cdzer.com:80/imgUpload/demo/basic/faceImg/150627092438056492HPvN.jpg";
//         star = "0.2";
//         userName = "150****7814";
//     }
