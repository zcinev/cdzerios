...
@interface AdvertisingScrollView () <UITableViewDataSource, UITableViewDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([urlString rangeOfString:@"http"].location == NSNotFound) {
        [imageView setImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:urlString ofType:@"jpg"]]];
    }else {
