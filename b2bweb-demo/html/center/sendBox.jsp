    ...
    <div class="row">
        ...
        <div class="col-md-10 pull-right paddingRight0 paddingLeft0">
            <div class="panel panel-default">
                ...
                <table class="table table-striped" >
                    ...
                    <tbody>
						<tr>
							 <td colspan="5" style="text-align:left;"><span class="ck-all-box btn btn-default">全选</span>
							  <button type="submit" class="delete-all-box btn btn-primary" onclick="delSendMessages();">删除选定</button> 
							 </td>
						</tr>
					</tbody>
                    <tr>
        ...
        <!-- 模态框（Modal） -->
			<div class="modal fade" id="myModal" style="top:5%;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			   <div class="modal-dialog" style="width: 862px;">
			      <div class="modal-content" style="width: 862px;">
			         	...
			         	<form class="form-horizontal" role="form">
							<div class="form-group">
							    <div class="col-sm-10 form-inline" style="margin-left: 5%;">
							    	<span style="margin-left: 10%;"><strong>发件人&nbsp;:&nbsp;</strong><span id="nichen"></span></span>
							    </div>
							</div>
							<div class="form-group">
							    <div class="col-sm-10 form-inline" style="margin-left: 5%;">
...
type:"POST",
dataType:"html",
url:"<%=basePath%>purchase/delSendMessages",
data:{"ids":arr},
async:false,
success:function(data){
window.location.href="<%=basePath%>purchase/sendBox";
},
error:function (){
alert("fail");
}
	...
	function ssfun() {
		...
		if (selectcont == 0) {
			for ( var i = 0; i < jsonarray.length; i++) {
				var trHtml  = "<tr><td>"
						+ jsonarray[i].index + "</td><td>" + jsonarray[i].receiver + "</td><td>"+ jsonarray[i].content+ "</td><td>"+ jsonarray[i].createTime
						+ "</td><td>" + jsonarray[i].bj +  "</td></tr>";
				if ((jsonarray[i].receiver).indexOf(keywordValue) >= 0) {
					if (buffercount < 10)
...
function senderDetail(obj){
	...
	$.ajax({
	     type : "POST",
	     url : "<%=basePath%>purchase/sendDetail",
	     dataType : "json",
		 async : false,
	     data : {id:obj},
	     success : function(data){
	     	document.getElementById("nichen").innerHTML=data[0].senderName;
