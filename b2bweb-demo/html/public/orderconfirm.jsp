	...
	<header>
                ...
                <div class="row">
                    ...
                    <%-- <a href="<%=BccHost.getHost()%>/b2bweb-baike" class="navbar-link">车队长首页</a>
                      ...
                      <%--   <img src='<%=basePath%>html/img/top_03.png' style="margin-top: -3px;margin-right:-10px;"> --%>
                        <a href="<%=basePath%>official/showProduct" class="navbar-link">官网产品</a> 
        ...
        <div class="navbar navbar-default marginBottom0">
	    	<div class="member-bg">
		        <div class="row">
		            <div class="pull-left">
		            	<a href="javascript:void()"><img src="<%=basePath%>html/img/newmember_logo.png"></a>
		            </div>
          ...
          <div class="container-fluid" >
            <div class="row" >
                <div class="paddingLeft0 col-md-7 pull-right" >
                 <img src="<%=basePath%>html/img/neworder2.png" class="img-responsive" alt="Responsive image" style="width: 80%;height: 90%;float: right;margin-top: 20px;">
               ...
               <div style="font: normal 24px/36px 'Microsoft yahei';height: 20px;margin-top: 30px;">我的购物车</div>  
                </div>
            </div>
        </div>
    </header>
...
<script type="text/javascript">
	...
	if((strName==null)||(strName=="null")||(strName==""));
		...
		if(typeId=="1")
		str = "<a href=\"<%=hostPath%>b2bweb-repair/person/showIndex?id="+strId+"&userName="+strName+"&typeId="+typeId+"\">"+strName+"！ </a><a href=\"<%=hostPath%>/pei/logout\"  >注销</a>";
		else
