					...
					<c:forEach var="mkey5" items="${autopart}">
						...
						<div class="item">
							...
							<c:if test="${mkey5['name']=='发动机'}">
								<div
									...
									<img src="<%=basePath%>html/images/indexfdj.png"
										style="float: left;width: 28px;margin-left: 20px;margin-top: 8px;" />
							...
							<c:if test="${mkey5['name']=='保养配件'}">
								<div style="width: 234px;height: 62px;text-align: center;padding-top: 8px;">
											...
											<dd>
												<c:forEach var="mkey7" items="${mkey6['autoPartInfo']}">
													<em>
													     ...
													     <a href="<%=basePath%>pei/product?id=${mkey7['infoid']}">${mkey7['name']}</a>
													     </c:if>
													        <c:if test="${mkey7['infoid']==''}">
													        <a href="<%=basePath%>pei/product?id=${mkey7['id']}">${mkey7['name']}</a>
													        </c:if>
													     </em>
												</c:forEach>
											</dd>
