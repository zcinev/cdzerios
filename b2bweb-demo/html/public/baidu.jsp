...
<body>
	<div style="width:260px;height:260px;border:#ccc solid 1px;" id="allmap"></div>
	...
	function getBaidu(coord){
	    ...
	    marker.addEventListener("click", function(){ 
			...
			var opts = {
				width : 80,     // 信息窗口宽度
				height: 70,     // 信息窗口高度
				title : centerName , // 信息窗口标题
				enableMessage:true,//设置允许信息窗发送短息
				message:centerAddress
			}
	    	...
	    	var infoWindow = new BMap.InfoWindow("电话："+centerTel+"<br/>地址："+centerAddress+"", opts);  // 创建信息窗口对象 
