...
<%
	...
	String pathbase=BccHost.getHost()+"/";
...
<link href="<%=basePath%>html/lib/dist/css/bootstrap.min.css"
	rel="stylesheet">
<link href="<%=basePath%>html/plugin/iCheck/skins/square/blue.css"
	rel="stylesheet">
...
<link href="<%=basePath%>html/plugin/HubSpot/css/messenger.css"
	rel="stylesheet">
<link
	href="<%=basePath%>html/plugin/HubSpot/css/messenger-theme-block.css"
	rel="stylesheet">
...
<body>
	...
	<header>
			...
			<div class="container-fluid">
				<div class="row">
                	...
                	<a href="#" class="navbar-link" role="button">消息</a> --%>
						<a href="<%=basePath%>/html/login.jsp" class="navbar-link"
							role="button">登录</a>
						<a href="<%=basePath%>/html/register.jsp" class="navbar-link"
							role="button">注册</a>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="pull-left">
						<a href="javascript:void();"><img
							src="<%=basePath%>html/img/newmember_logo.png">
						</a>
					</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="paddingLeft0 col-md-7 pull-right"
					style="padding-top: 18px;">
					<img src="<%=basePath%>html/img/neworder1.png"
						class="img-responsive" alt="Responsive image"
						style="width: 80%;height: 90%;float: right;margin-right: -16px;">
				...
				<div class="paddingRight0 col-md-3 ">
					...
					<div
						style="font: normal 24px/36px 'Microsoft yahei';height: 20px;margin-top: 30px;margin-left: -16px;">我的购物车</div>
				</div>
			</div>
		</div>
	</header>
...
<%-- 	<script type="text/javascript">
	...
	if((strName==null)||(strName=="null")||(strName==""));
		...
		str = "<a href=\"<%=hostPath%>b2bweb-repair/person/showIndex?id="+strId+"&userName="+strName+"&typeId="+typeId+"\">"+strName+"</a><a href=\"<%=hostPath%>b2bweb-demo/pei/logout\"  role=\"button\">注销</a>";
