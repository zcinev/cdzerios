    ...
    <div class="row">
        ...
        <div class="col-md-10 pull-right paddingRight0 paddingLeft0">
            <div class="panel panel-default">
                ...
                <form class="form-inline" role="form" style="margin:10px;" id="searchForm" action="<%=basePath%>member/tradeFail">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#">查看</a>
                           <a href="<%=basePath%>member/delTradeFailList?mainOrderId=${mkey['orderMainId']} ">删除</a>
                        </td>
                    </tr>
