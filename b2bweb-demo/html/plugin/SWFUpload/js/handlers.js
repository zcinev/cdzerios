...
function addImage(src) {
    var newElement = "<dl><dt><img class='content' src='" + src + "' style=\"width:100px;height:100px;\"><img class='button' src=" + window.path + "/images/fancy_close.png></dt><dd><input type=\"text\" name=\"intro[]\" style=\"display:inline-block;width:96px;\" /><input type=\"hidden\" name=\"src[]\" value=" + src + " /></dd><dd class=\"set_first\"><input type=\"button\" value=\"设为封面\"><input class=\"sort\" type=\"hidden\" name=\"sort[]\" value=\"0\" /></dd></dl>";
